...
namespace BoltOn.Tests.Cqrs
{
	...
	{
		// error occurs in the consumer, eventstobeprocessed should not be removed
		...
		[Fact]
		public async Task MediatorProcessAsync_WithCqrsAndDefaultClearEventsDisabled_RemovesEventsToBeProcessedAndProcessedEvents()
		{
			var serviceCollection = new ServiceCollection();
			serviceCollection.BoltOn(b =>
			{
